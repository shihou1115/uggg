...
| **4** | **実装着手**（垂直スライス・M0〜M6） | src/, src-tauri/src/ | ✅ M0〜M6 完了、**v0.1.4 リリース済**（2026-07-11、タグ `v0.1.4`）。**M7〜M10（日常支援 Tier S 全 4 機能）実装済み**（2026-07-18、M7+M8=`1ab7e01`・M9=`84650b5` コミット済、M10 未コミット。**次は v0.2 リリース**、releasing-ugg skill 使用） |
