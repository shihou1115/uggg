...
| docs/architecture.md | モジュール構成・契約・設計判断 | v1.7 ✅（M7〜M12 + **掛け合いパターン3/4 の3つ目の吹き出し**契約反映済み） |
| docs/test-plan.md | テスト戦略・手動チェックリスト | v1.4 ✅（§5 F 節に天気 F-1〜8 + 定例会話 F-9〜15、§5.8 実機検証記録。A-3/B-4 を具体化。Tier S §4.6 手動項目は未追加の負債あり） |
